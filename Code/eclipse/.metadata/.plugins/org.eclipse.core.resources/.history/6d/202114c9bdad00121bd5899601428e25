...
public class betterfood {
	...
	public void initCraftingRecipes() {
		...
		//abkürzen von Blöcken oder Items
		...
		//Beispiel ohne anordnung in der Workbench mit mehreren Blöcken
		...
		//Beispiel mit anordnung in der Workbench mit mehreren Blöcken
